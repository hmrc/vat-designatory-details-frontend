...
object UpdateBusinessNameViewMessages {
  ...
  val secondParagraph = "Updates are usually done within 2 working days. However, they can take several weeks if we need " +
    "to carry out additional checks."
  val buttonTextIndividual = "View your business details"
  val buttonTextAgent = "View your client’s business details"
}
